    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.description=[Photoshow](https://github.com/Kangaroux/PhotoShow) is gallery software at its easiest, it doesn't even require a database.\" \
